                    ...
                    post.preview ?
                        <div>
                            {!post.url.includes('png') && !post.url.includes('jpg') ?
                                ...
                                : ''}{console.log("post",post, post.preview.images[0].source.url.replace('amp;', ''))}
                            <a target="_blank" rel="noreferrer" href={post.url}>
                                {post.preview.images[0].source.url && <img src={post.preview.images[0].source.url.replaceAll('amp;', '')} alt='' />}
